...
import group.qam2.utilities.CountryQuery;
import group.qam2.utilities.CustomerQuery;
import group.qam2.utilities.DivisionQuery;
...
public class CustomerController implements Initializable {
    ...
    /**
     * Checks for various input errors. Errors to check for are customer names not containing letters, phone numbers containing letters,
     * and empty input fields.
    ...
    private boolean errorCheck(boolean pass) {
        ...
        if(isLetter(phoneTxt.getText())) {
            phoneError.setText("Please do not enter letters.");
            pass = false;
        }
    ...
    private void addCust() throws SQLException {
        ...
        CustomerQuery.insert(custNameTxt.getText(), addressTxt.getText(), postalTxt.getText(), phoneTxt.getText(), divId);
    }
    ...
    private void updateCust() throws SQLException {
        ...
        CustomerQuery.update(Integer.parseInt(custIdTxt.getText()), custNameTxt.getText(), addressTxt.getText(),
                postalTxt.getText(), phoneTxt.getText(), divId);
    }

...
public class ReportController implements Initializable {
    ...
    @FXML private ComboBox<String> typeBox = new ComboBox<>();
     ...
     * LAMBDA: Lambda was used to simplify removing duplicates from a list.
     * @param url
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            for(Appointment appt : AppointmentQuery.select()) {
                aList.add(appt.getType());
            }
            List<String> aListNoDup = aList.stream().distinct().collect(Collectors.toList());
            aList = FXCollections.observableArrayList(aListNoDup);
            typeBox.setItems(aList);
